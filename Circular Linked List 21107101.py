...
1.games:-
  #In an online game of chess, the white and black pieces must be played alternatively, hence it a shart circular loop with only two nodes.
...
2. computer applications:-
    #Implementation of Data Structure such as stacks and queues are implemented with the help of the circular linked list. 

    #Circular linked list is also used in computer networking for token scheduling.
...
3. In my field:-(mechanical)
    # as my field is mechanical there are some applications; for eg, in the filed of manufacturing, if we use mechatronics systems like packaging machines, then a specific set of actions has to be repeated by a machine, which can be achieved with circular linked list. 
